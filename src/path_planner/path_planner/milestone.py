...
def TrajectoryGenerator(T_sei, T_sci, T_scg, T_ce_grasp, T_ce_standoff,Time):
    ...
    '''
    T_sei : initial configuration of the end-effector in the reference trajectory
...
def moveBlockOperation(T_sci, T_scg, currConfiguration, T_sei, Kp, Ki):
    ...
    createCSV(fullConfigurationList,"CapstoneProject/capstone.csv")
    print("Generating error plot data")
    createCSV(error,"CapstoneProject/error.csv", ["W_x_error","W_y_error","W_z_error","V_x_error","V_y_error","V_z_error"])
    print("Done.")
