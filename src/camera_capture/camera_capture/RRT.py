...
def solveMaze(startPoint = [605,84], goalPoint = [59,418], workspace_path = '/home/chris/capstone/hitc_ws/src/camera_capture/camera_capture/processed_workspace.npy', iterations = 1000, stepLength = 100):
